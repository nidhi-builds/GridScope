...
export function OperationsPage() {
  const { data, updatedAt, error, loading, refresh, selectedIncidentId, selected, select, filters, setFilters, resetQueue, canResetQueue, incidents, overview } = useOperations();
